            ...
            default:
                ...
                return {
                    ...
                    body: JSON.stringify({
                        ...
                        version: '2.0.0',
                        endpoints: {
                            '/api?action=proxies&country=SG': 'Get Singapore proxies',
                            '/api?action=proxies&country=MY': 'Get Malaysia proxies',
                            '/api?action=proxies&format=text': 'Get proxies as text',
                            '/api?action=working': 'Get working proxies',
                            '/api?action=random&country=SG': 'Get random Singapore proxy',
                            '/api?action=check&proxy=IP:PORT': 'Check proxy status',
                            '/api?action=statistics': 'Get system statistics',
                            '/api?action=countries': 'Get available countries'
                        },
                        example: 'https://your-site.netlify.app/api?action=proxies&country=SG'
                    })
                };
        }
    } catch (error) {
